package litesuits.android.async;
...
public class TaskExecutor {
     ...
     * @param unit
     */
    public static void startDelayedTask(final AsyncTask<Object, Object, Object> task, long time, TimeUnit unit) {
        long delay = time;
    ...
    public static class OrderedTaskExecutor {
        LinkedList<AsyncTask<Object, Object, Object>> taskList = new LinkedList<AsyncTask<Object, Object, Object>>();
        private transient boolean isRunning = false;

        public OrderedTaskExecutor put(AsyncTask<Object, Object, Object> task) {
        ...
        private void executeNext() {
            AsyncTask<Object, Object, Object> next = null;
            if (taskList.size() > 0) {
    ...
    public static class CyclicBarrierExecutor {
        ArrayList<AsyncTask<Object, Object, Object>> taskList = new ArrayList<AsyncTask<Object, Object, Object>>();
        private transient boolean isRunning = false;

        public CyclicBarrierExecutor put(AsyncTask<Object, Object, Object> task) {
            if (task != null) taskList.add(task);
            return this;
        }

        public void start(final AsyncTask<Object, Object, Object> finishTask) {
            start(finishTask, 0, null);
        }

        @SuppressWarnings("unchecked")
        public void start(final AsyncTask<Object, Object, Object> endOnUiTask, final long time, final TimeUnit unit) {
        ...
        private void startInternal(final CountDownLatch latch) {
            for (AsyncTask<Object, Object, Object> each : taskList) {
